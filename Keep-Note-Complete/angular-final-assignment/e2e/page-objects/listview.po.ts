...
export class ListViewPage {
  ...
  // get note data
  getMockNote(): any {
    const note: any = { title: 'Read Angular 1 blog', content : 'Shall do at 6 pm'};
    return note;
  }
  ...
  // get note data
  getEditMockNote(): any {
    const note: any = { title: 'Read Angular 5 blog', content : 'Shall do at 10.30 pm', state: 'not-started'};
    return note;
  }
  // set input fileds values with mock data
  editNoteValues(): any {
