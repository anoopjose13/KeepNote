...
describe('note view page', () => {
  ...
  it('should render take a note card', () => {
    ...
    expect(page.isTextInputBoxPresent()).toBeTruthy('Content input box should exist with name attribute as content');
  ...
  it('should open edit note model on clicking a note', () => {
    ...
    expect(page.isEditTextInputBoxPresent()).toBeTruthy('Content input box should exist with name attribute as editContent');
    expect(page.isEditStatusInputBoxPresent()).toBeTruthy('Status select box should exist with name attribute as editStatus');
    expect(page.isSaveButtonPresent()).toBeTruthy('Save button exists with Save content');
  });
  ...
  it('should edit a note', () => {
    ...
    page.clickLastNote();
    expect(page.isEditTitleInputBoxPresent()).toBeTruthy('Title input box should exist with name attribute as editTitle');
    expect(page.isEditTextInputBoxPresent()).toBeTruthy('Content input box should exist with name attribute as editText');
    expect(page.isEditStatusInputBoxPresent()).toBeTruthy('Status select box should exist with name attribute as editStatus');
    expect(page.isSaveButtonPresent()).toBeTruthy('Save button exists with Save text');
    const editNoteValues = page.editNoteValues();
    expect(page.getEditNoteDefaultValues()).toEqual(editNoteValues, 'Should be able to set values for note title and content');
