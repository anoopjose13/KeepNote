...
namespace NoteService.Test
{
    public class DatabaseFixture : IDisposable
    {
        ...
        public DatabaseFixture()
        {
            ...
            context.Notes.DeleteMany(filter);
            context.Notes.InsertMany(new List<NoteUser>
            {
                new NoteUser{
                    UserId="Mukesh", Notes=new List<Note>{
                        new Note { Id=131, Category= new Category{Id=101, Name="Sports", CreatedBy="Mukesh", Description="All about sports", CreationDate=new DateTime() },
